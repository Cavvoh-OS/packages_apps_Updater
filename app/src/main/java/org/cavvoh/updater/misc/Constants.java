 ...
 */
package org.cavvoh.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_DEVICE = "ro.cavvoh.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "cavvoh.updater.allow_downgrading";
